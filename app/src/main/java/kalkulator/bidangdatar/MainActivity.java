    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Lingkaran.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                        Intent lingkaran = new Intent(MainActivity.this, LingkaranActivity.class);
        ...
        Segitiga.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent segitiga = new Intent(MainActivity.this, SegitigaActivity.class);
        ...
        Persegi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent persegi = new Intent(MainActivity.this, PersegiActivity.class);
